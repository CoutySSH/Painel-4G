...
wget https://raw.githubusercontent.com/CoutySSH/Painel-4G/main/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/CoutySSH/Painel-4G/main/install/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/CoutySSH/Painel-4G/main/install/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/CoutySSH/Painel-4G/main/install/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/CoutySSH/Painel-4G/main/install/whatsapp.sh > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/CoutySSH/Painel-4G/main/install/gestorssh.zip > /dev/null 2>&1
